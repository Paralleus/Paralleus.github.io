		...
		for(i=0;i<links.length;i+=3){
			if(links[i].indexOf("FAVICON:") > -1){
				if(links[i+1].indexOf("LINK:") > -1){
					data+="<a href='"+links[i+1].replace("LINK:","")+"'><img style='margin: 0px !important;background-color:white;text-align: center !important;width: 16px !important;border-style:solid !important;border-color:#FFF !important;border-width:1px !important;border-radius: 50px !important;' height='16' width='16' src='"+links[i].replace("FAVICON:","")+"'></a>&nbsp;&nbsp;&nbsp;"
				}
			}
		}
